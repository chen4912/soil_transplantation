...
df2$Soil_source <- factor(df2$Soil_source, levels = c("Low","Mid","High"))
...
ggplot(Pasi, aes(x = house, y = field)) +
  ...
  geom_abline(slope = -14.38, intercept = 0.07, linetype = "dashed", color = "#4CAB3B") +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none",
...
ggplot(Trep, aes(x = house, y = field, color = species)) +
  ...
  labs(y = "Filed", x = "Greenhouse", title = NULL) +
  geom_abline(slope = 1, intercept = 0, linetype = "solid", color = "black") +
  geom_abline(slope = -2.00, intercept = -0.195, linetype = "dashed", color = "#B7352A") +
  theme_bw() +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        legend.position = "none",
