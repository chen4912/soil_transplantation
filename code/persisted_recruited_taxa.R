...
#### rhizosphere
#bacteria_OTU_abun = read.xlsx("trans.xlsx", sheet = "rhizos", rowNames = T, colNames = T)

bacteria_OTU_abun = read.xlsx("chen.xlsx", sheet = "fungi", rowNames = T, colNames = T)###OTU data
...
#write.table(home_result, file ="home_result1_rhizos.csv",sep =",", quote =FALSE)
...
#write.table (nohome_result, file ="nohome_result1_fungi.csv",sep =",", quote =FALSE)
