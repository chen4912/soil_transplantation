getwd()
setwd("D:/桌面/soil_transplantation/data/")
...
#### rhizosphere
#bacteria_OTU_abun = read.xlsx("../OTU_matrix.xlsx", sheet = "rhizos", rowNames = T, colNames = T)

bacteria_OTU_abun = read.xlsx("../OTU_matrix.xlsx", sheet = "fungi", rowNames = T, colNames = T)
### Load the OTU abundance table here, where rows are OTUs, columns are samples, 
### Note that the sample number and the sample number of OTU_group are consistent
